...
// ======= Sled Kind =======
const LugeKind = ({ scene, selectedColor, backgroundColor, guide }) => {
  ...
  useEffect(() => {
    ...
    // ======= Chassis =======
    const tubeGroupLeft = [
      createTubeChassisLeft(backgroundColor, -0.65, 0.15, -0.26, 0, -0.1, -0.4),
      createTubeChassisLeft(backgroundColor, -0.1, 0.16, -0.26, 0, 0, 0.2),
    ];
    ...
    const tubeGroupRight = [
      createTubeChassisRight(backgroundColor, -0.65, 0.15, 0.26, 0, 0.1, -0.4),
      createTubeChassisRight(backgroundColor, -0.1, 0.16, 0.26, 0, 0, 0.2),
    ];
    ...
    const capGroupBtm = [
      createCapBottom(backgroundColor, -0.78, 0.07, 0.26, 0, 0, 0),
      createCapBottom(backgroundColor, -0.78, 0.07, -0.26, 0, 0, 0),
    ];
    ...
    const capGroupTop = [
      createCapTop(backgroundColor, 0.63, 0.471, 0.169, 0, 0, 0),
      createCapTop(backgroundColor, 0.63, 0.471, -0.169, 0, 0, 0),
    ];
